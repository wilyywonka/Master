...
# CALC INITIAL VALS #
# ----------------------------------------------------------------------------------------------------------------------------
@time InitializeSystem(NPart,ρ,D,spread,finalMeanRad,growSize,RandDist,NTimeSteps,Extrasteps,A,dt,saveEvery,BrownianMethodFunc,BoundaryMethodFunc,b,false)
# ----------------------------------------------------------------------------------------------------------------------------
